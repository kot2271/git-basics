package com.telros.app.views.main;
...
import com.telros.app.views.login.LoginView;
...
public class MainView extends AppLayout {
  ...
  private Component createDrawerContent(Tabs menu) {
    ...
    logoLayout.add(new Image("images/logo.png", "Telros App logo"));
    logoLayout.add(new H1("Telros App"));
